...
class Day9Suite extends AnyFunSuite with should.Matchers {
  ...
  ignore("solve problem part 2") {
    Day9.highScoreOpt(10, 1618) shouldBe 8317
    Day9.highScoreOpt(13, 7999) shouldBe 146373
    Day9.highScoreOpt(17, 1104) shouldBe 2764
    Day9.highScoreOpt(21, 6111) shouldBe 54718
    Day9.highScoreOpt(30, 5807) shouldBe 37305
